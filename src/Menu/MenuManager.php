...
use Yard\Gutenberg\PageSettings\PageSettingsManager;
...
class MenuManager
{
    ...
    public function registerAdminMenu(): void
    {
        ...
        \add_action('load-' . $settingsMenu, [$pageSettingsManager, 'enqueueAssets']);
